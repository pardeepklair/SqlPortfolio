...
--What are the three highest earning employees?--
...
--Which client generates the most sales?--
...
FROM Client
	INNER JOIN
		Works_With
	ON
		Client.client_id = Works_With.client_id
GROUP BY Client.client_name,
			Works_With.total_sales
ORDER BY Works_With.total_sales DESC


--Average Salary of Males/Females--
...
--Salary for employees working in the Scranton branch?--
